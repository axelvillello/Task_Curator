/*
 * A class to define functionality for the Add Task page
 * Acts as an entry form for new tasks to be entered
 */
...
public partial class AddTask : ContentPage
{
    ...
    public AddTask(int i)
    {
        ...
        DueDatePicker.Date = DateTime.Now.Date;
        StartTimePicker.Time = DateTime.Now.TimeOfDay;
        DueTimePicker.Time = DateTime.Now.TimeOfDay;
    }
        ...
        else
        {
            ...
            if ((dueDateTime != startDateTime && dueDateTime > startDateTime) && (dueDateTime != DateTime.Now && dueDateTime > DateTime.Now))
            {
                ...
                if (tDT.Reminders == true)
                {
                    ...
                    notificationTime = notificationTime.AddHours(-6);
                ...
                NotificationManager.ShowToast("The task of " + TaskNameEntry.Text + " was created!");
